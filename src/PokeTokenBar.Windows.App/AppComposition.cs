...
public static class AppComposition
{
    ...
    [
        ...
        Configured("antigravity", "Antigravity", true, () => LocalAntigravityUsageProvider.GetDefaultRoots(), customRoots,
            roots => new LocalAntigravityUsageProvider(roots)),
        Configured("cursor", "Cursor", true, () => LocalCursorUsageProvider.GetDefaultRoots(), customRoots,
        ...
        Configured("copilot", "Copilot", true, () => LocalCopilotUsageProvider.GetDefaultRoots(), customRoots,
            roots => new LocalCopilotUsageProvider(roots)),
        Configured("kiro", "Kiro", true, () => LocalKiroUsageProvider.GetDefaultRoots(), customRoots,
            roots => new LocalKiroUsageProvider(roots)),
        Configured("pi", "Pi", true, () => LocalPiUsageProvider.GetDefaultRoots(), customRoots,
