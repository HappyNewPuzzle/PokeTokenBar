...
public sealed class LocalizationService : INotifyPropertyChanged
{
    ...
    public string Details => T("상세", "Details", "詳細", "Detalles", "Détails", "Detalhes", "Details");
    public string Back => T("뒤로", "Back", "戻る", "Volver", "Retour", "Voltar", "Zurück");
    public string Retry => T("다시 시도", "Retry", "再試行", "Reintentar", "Réessayer", "Tentar novamente", "Erneut versuchen");
    public string LoadingPokemonDetails => T("Pokémon 상세 정보 로딩 중…", "Loading Pokémon details…", "Pokémonの詳細を読み込み中…", "Cargando detalles del Pokémon…", "Chargement des détails du Pokémon…", "Carregando detalhes do Pokémon…", "Pokémon-Details werden geladen…");
    public string PokemonDetailsUnavailable => T("Pokémon 상세 정보를 불러오지 못했습니다.", "Pokémon details could not be loaded.", "Pokémonの詳細を読み込めませんでした。", "No se pudieron cargar los detalles del Pokémon.", "Impossible de charger les détails du Pokémon.", "Não foi possível carregar os detalhes do Pokémon.", "Die Pokémon-Details konnten nicht geladen werden.");
    public string Individual => T("개체", "Individual", "個体", "Individuo", "Individu", "Indivíduo", "Individuum");
    public string Level => T("레벨", "Level", "レベル", "Nivel", "Niveau", "Nível", "Level");
    public string Gender => T("성별", "Gender", "性別", "Sexo", "Sexe", "Sexo", "Geschlecht");
    public string Nature => T("성격", "Nature", "性格", "Naturaleza", "Nature", "Natureza", "Wesen");
    public string Ability => T("특성", "Ability", "特性", "Habilidad", "Talent", "Habilidade", "Fähigkeit");
    public string HiddenAbility => T("숨겨진 특성", "Hidden Ability", "隠れ特性", "Habilidad oculta", "Talent caché", "Habilidade oculta", "Versteckte Fähigkeit");
    public string Hidden => T("숨겨짐", "Hidden", "隠れ", "Oculta", "Caché", "Oculta", "Versteckt");
    public string KnownMoves => T("배운 기술", "Known moves", "覚えた技", "Movimientos aprendidos", "Capacités apprises", "Golpes aprendidos", "Erlernte Attacken");
    public string NoLevelMoves => T("현재 레벨에서 배운 레벨업 기술이 없습니다.", "No level-up moves learned at this level.", "このレベルで覚えたレベルアップ技はありません。", "No se han aprendido movimientos por nivel a este nivel.", "Aucune capacité apprise par montée de niveau à ce niveau.", "Nenhum golpe aprendido por nível neste nível.", "Auf diesem Level wurden keine Level-Attacken erlernt.");
    public string ActualStats => T("실제 능력치", "Actual stats", "実際の能力値", "Estadísticas reales", "Statistiques réelles", "Estatísticas reais", "Tatsächliche Statuswerte");
    public string BaseStats => T("종족값", "Base stats", "種族値", "Estadísticas base", "Statistiques de base", "Estatísticas base", "Basiswerte");
    public string SpeciesData => T("종 정보", "Species data", "種族情報", "Datos de la especie", "Données de l’espèce", "Dados da espécie", "Artinformationen");
    public string Types => T("타입", "Types", "タイプ", "Tipos", "Types", "Tipos", "Typen");
    public string Height => T("키", "Height", "高さ", "Altura", "Taille", "Altura", "Größe");
    public string Weight => T("몸무게", "Weight", "重さ", "Peso", "Poids", "Peso", "Gewicht");
    public string BaseTotal => T("종족값 합계", "Base total", "種族値合計", "Total base", "Total de base", "Total base", "Basiswertsumme");
    public string PossibleAbilities => T("가능한 특성", "Possible abilities", "可能な特性", "Habilidades posibles", "Talents possibles", "Habilidades possíveis", "Mögliche Fähigkeiten");
    public string CompleteMoveList(int count) => T($"전체 기술 목록 {count}개", $"Complete move list · {count}", $"全技一覧 · {count}", $"Lista completa de movimientos · {count}", $"Liste complète des capacités · {count}", $"Lista completa de golpes · {count}", $"Vollständige Attackenliste · {count}");
    public string Male => T("수컷", "Male", "オス", "Macho", "Mâle", "Macho", "Männlich");
    public string Female => T("암컷", "Female", "メス", "Hembra", "Femelle", "Fêmea", "Weiblich");
    public string Genderless => T("성별 없음", "Genderless", "性別不明", "Sin sexo", "Asexué", "Sem sexo", "Geschlechtslos");
    public string Attack => T("공격", "Attack", "攻撃", "Ataque", "Attaque", "Ataque", "Angriff");
    public string Defense => T("방어", "Defense", "防御", "Defensa", "Défense", "Defesa", "Verteidigung");
    public string SpecialAttack => T("특수공격", "Sp. Atk", "特攻", "At. Esp.", "Atq. Spé.", "Atq. Esp.", "Spez.-Ang.");
    public string SpecialDefense => T("특수방어", "Sp. Def", "特防", "Def. Esp.", "Déf. Spé.", "Def. Esp.", "Spez.-Vert.");
    public string Speed => T("스피드", "Speed", "素早さ", "Velocidad", "Vitesse", "Velocidade", "Initiative");
    public string StartMove => T("시작", "Start", "最初", "Inicial", "Départ", "Inicial", "Start");
    public string EggMove => T("알", "Egg", "タマゴ", "Huevo", "Œuf", "Ovo", "Ei");
    public string Tutor => T("가르침", "Tutor", "教え技", "Tutor", "Maître", "Tutor", "Lehrer");
    ...
    public string EggPurchaseLockedHint => T("지금 품고 있는 알이 부화하면 살 수 있어요.", "Available once your current egg hatches.", "いま抱えているタマゴが孵ると購入できます。", "Disponible cuando eclosione tu huevo actual.", "Disponible une fois ton œuf actuel éclos.", "Disponível quando seu ovo atual chocar.", "Verfügbar, sobald dein aktuelles Ei geschlüpft ist.");
    ...
    public string CheckingForUpdates => T("업데이트 확인 중…", "Checking for updates…", "アップデートを確認中…", "Buscando actualizaciones…", "Recherche de mises à jour…", "Buscando atualizações…", "Updates werden gesucht…");
    ...
    public string UpdateAvailableDetails(string current, string latest) => T($"업데이트 가능\n현재: {current}\n최신: {latest}", $"Update available\nCurrent: {current}\nLatest: {latest}", $"アップデートがあります\n現在: {current}\n最新: {latest}", $"Actualización disponible\nActual: {current}\nÚltima: {latest}", $"Mise à jour disponible\nActuelle : {current}\nDernière : {latest}", $"Atualização disponível\nAtual: {current}\nMais recente: {latest}", $"Update verfügbar\nAktuell: {current}\nNeueste: {latest}");
